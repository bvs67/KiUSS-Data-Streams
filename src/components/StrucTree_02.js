...
//    ul_var = (
//        <ul> 
//            <li><span><a href="#{node.id_RG}">Дальний Восток</a></span></li> 
//            <ul> 
//                <li><span><a href="#{node.id_DO}">АО "РН-Шельф-Дальний Восток"</a></span></li> 
//                <li><span><a href="#{node.id_DO}">ООО "Венинефть"</a></span></li> 
//                <li><span><a href="#{node.id_DO}">ООО "РН-Сахалинморнефтегаз"</a></span></li> 
//                <li><span><a href="#{node.id_DO}">ООО "РН-Шельф-Арктика"</a></span></li> 
//            </ul> 
//            <li><span><a href="#{node.id_RG}">Западная Сибирь</a></span></li> 
//            <ul> 
//                <li><span><a href="#{node.id_DO}">АО "Корпорация Югранефть"</a></span></li> 
//                <li><span><a href="#{node.id_DO}">АО "Нижневартовское нефтегазодобывающее предприятие"</a></span></li> 
//                <li><span><a href="#{node.id_DO}">АО "НК "Конданефть"</a></span></li> 
//                <li><span><a href="#{node.id_DO}">АО "РН-Няганьнефтегаз"</a></span></li> 
//                <li><span><a href="#{node.id_DO}">АО "Роспан Интернешнл"</a></span></li> 
//                <li><span><a href="#{node.id_DO}">АО "Русско-Реченское"</a></span></li> 
//                <li><span><a href="#{node.id_DO}">АО "Самотлорнефтегаз"</a></span></li> 
//                <li><span><a href="#{node.id_DO}">АО "Сибнефтегаз"</a></span></li> 
//                <li><span><a href="#{node.id_DO}">АО "Тюменнефтегаз"</a></span></li> 
//                <li><span><a href="#{node.id_DO}">ОАО "РН-Нижневартовск"</a></span></li> 
//                <li><span><a href="#{node.id_DO}">ОАО "Томскнефть" Восточной нефтяной компании</a></span></li> 
//                <li><span><a href="#{node.id_DO}">ООО "РН-Пурнефтегаз"</a></span></li> 
//                <li><span><a href="#{node.id_DO}">ООО "РН-Уватнефтегаз"</a></span></li> 
//                <li><span><a href="#{node.id_DO}">ООО "РН-Юганскнефтегаз"</a></span></li> 
//                <li><span><a href="#{node.id_DO}">ООО "Северо-Варьеганское"</a></span></li> 
//                <li><span><a href="#{node.id_DO}">ООО "Соровскнефть"</a></span></li> 
//                <li><span><a href="#{node.id_DO}">ООО "СП "Ваньеганнефть"</a></span></li> 
//                <li><span><a href="#{node.id_DO}">ПАО "Варьеганнефтегаз"</a></span></li> 
//            </ul>
//        </ul>    
//    )
...
// ---------------------------------------------------------------
//        }, this);
 return {__html: ul_var};    
// <div dangerouslySetInnerHTML={this.render2()} />
//return ul_var;   
//{this.render2()}
